...
import argparse
import torch
import defenses.mahalanobis.data_loader as data_loader
import numpy as np
import defenses.mahalanobis.calculate_log as callog
import defenses.mahalanobis.models as models
import os
import defenses.mahalanobis.lib_generation as lib_generation
...
parser.add_argument('--dataset', required=True, help='mnist| cifar10 | cifar100 | svhn')
...
def main():
    ...
    if args.net_type == 'densenet':
        ...
        model = models.ResNet34(num_c=args.num_classes, dataset=args.dataset)
        if args.dataset == 'mnist':
            checkpoint = torch.load("../../classifiers/mnist_classifier/models/state_epoch11_mahalanobis_mnist.pt")
    ...
    for magnitude in m_list:
        ...
        for i in range(num_output):
            ...
            = lib_generation.get_Mahalanobis_score_adv(model, test_clean_data, test_label, \
                                                       args.num_classes, args.net_type, \
                                                       sample_mean, precision, i, magnitude, dataset=args.dataset)
